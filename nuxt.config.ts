export default defineNuxtConfig({
  ...
  fonts: {
    families: [
      { name: 'Roboto Flex', provider: 'google', weights: ['300..700'], display: 'fallback', preload: true },
  ...
  nitro: {
    routeRules: {
      ...
      '/api/images/**': { proxy: `${process.env.NUXT_PUBLIC_API_BASE_URL || 'http://localhost:8080'}/images/**`, cache: { maxAge: 604800 } },
    }
  },
  runtimeConfig: {
