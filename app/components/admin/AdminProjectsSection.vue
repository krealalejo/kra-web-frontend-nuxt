...
<template>
  <div>
    ...
    <div v-if="pageError" class="mb-6 rounded px-3 py-2 text-xs" style="background:rgba(220,38,38,0.1);color:#dc2626;border:1px solid rgba(220,38,38,0.25);font-weight:500">
      {{ pageError }}
    </div>
